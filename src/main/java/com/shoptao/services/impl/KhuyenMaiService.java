...
public class KhuyenMaiService implements ChungServices<KhuyenMaiViewModle> {
    ...
    public KhuyenMaiViewModle getOne(String ma) {
        ...
        KhuyenMaiViewModle khuyenMaiViewModle = new KhuyenMaiViewModle(khuyenmai.getId(), khuyenmai.getMa(), khuyenmai.getTen(), khuyenmai.getGiatri(), khuyenmai.getHinhthucgiamgia(), khuyenmai.getDieukiengiamgia(), khuyenmai.getNgaybatdau(), khuyenmai.getNgayketthuc(), khuyenmai.getTrangthai());
