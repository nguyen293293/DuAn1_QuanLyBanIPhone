...
//        loadDataTable(listImeiDaBan);
    ...
    private void initComponents() {
        ...
        btnAll.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        btnAll.setText("All");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(btnAll, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        System.out.println(soluongimei);
            ...
            if (Boolean.valueOf(tbImei.getValueAt(i, 2) + "") == true) {
                ...
                for (ImeiViewModel x : listImei) {
                    tableModel.addRow(new Object[]{
                        tbImei.getRowCount() + 1, x.getMaimei(), false
                    });
                }
            } else {
                tableModel.setRowCount(0);
                for (ImeiViewModel x : listImei) {
                    tableModel.addRow(new Object[]{
                        tbImei.getRowCount() + 1, x.getMaimei(), true
                    });
                }
            }
        }
