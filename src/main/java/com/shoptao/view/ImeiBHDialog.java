...
public class ImeiBHDialog extends javax.swing.JDialog {
    ...
    SanPhamViewModle sanPhamViewModle = new SanPhamViewModle();
    public ImeiBHDialog(java.awt.Frame parent, boolean modal, SanPhamViewModle sanPham) {
        super(parent, modal);
        initComponents();
        
        this.sanPhamViewModle = sanPham;
...
//            java.util.logging.Logger.getLogger(ImeiBHDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                ImeiBHDialog dialog = new ImeiBHDialog(new javax.swing.JFrame(), true);
